...
const Profile = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Only append imageUrl if it exists and no new file is selected
      if (profile.imageUrl && !selectedFile) {
      ...
      setTimeout(() => navigate('/home_driver'), 2000);
    } catch (error: unknown) {
